...
namespace HostileTakeover2.Thraxus.Utility.UserConfig.Models
{
    ...
    public class DefaultSettings
    {
        ...
        public string GetSettingsDescription(string validCategoryNames) =>
            ...
            $"\n\t\t* {nameof(MirrorEasyNpcTakeovers)} default is {MirrorEasyNpcTakeovers.Default} [{MirrorEasyNpcTakeovers.Type}].  When true, forces UseHighlights, UseWeaponGroup, UseMedicalGroup, UseTrapGroup, and AllowPlayerHacking all off, and resets all other non-debug settings to their defaults, overriding any user customisation to mirror EasyNpcTakeovers behaviour." +
